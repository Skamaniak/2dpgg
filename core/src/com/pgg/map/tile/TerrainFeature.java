...
public enum TerrainFeature {
    ...
    FORREST("terrain/tileset-forrest.png",0.8f, EnumSet.of(Biome.MEADOW, Biome.GRASS)),
    ISLAND("terrain/tileset-island.png",1.3f, EnumSet.of(Biome.WATER)),
    MOUNTAIN("terrain/tileset-mountain.png",0.8f, EnumSet.of(Biome.GRASS, Biome.HILLS)),
